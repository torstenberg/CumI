...
## The biotope map
The biotope map is based on the *Emodnet broad-scale seabed habitat map for Europe* (= EUSeapMap).
...
The pressure data used here were provided by HELCOM as a result of a data call to the contracting parties:
...
if (use_pre_calculated_data) {
	...
	fishing_file_pre <- file.path(myDir,"Fishery/fishery_pre_calculated.shp")
...
mari_1_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-01/finfish mariculture/Finfish_PLC/Finfish_PLC.shp")
...
mari_2_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-01/shellfish mariculture/Aquaculture_Shellfish_EMODnets/Aquaculture_Shellfish_EMODnets.shp")
...
extraction_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-01/extraction of sand and gravel/Extraction_of_sand_and_gravel/ExtractonSandGravel.shp")
...
deposit_1_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-01/depositing of dredged material/depositing/depositing_areas_dissolved.shp")
...
deposit_1_de_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-05/HOLAS3_correction_DE/Corrected_depositing_of_dredged_material/depositing_areas_DE.shp")
...
deposit_1_se_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-05/SE Helcom/HELCOM_Deposit_polygon.shp")
...
deposit_2_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-01/depositing of dredged material/depositing/depositing_points.shp")
deposit_2 <- st_read(deposit_2_file)

# corrections from DE:
deposit_2_de_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-05/HOLAS3_correction_DE/Corrected_depositing_of_dredged_material/depositing_points_DE.shp")
...
deposit_2_se_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-05/SE Helcom/HELCOM_Deposit_point.shp")
...
```{r}
deposit_3_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-01/depositing of dredged material/depositing/depositing_lines.shp")
...
deposit_3_de_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-05/HOLAS3_correction_DE/Corrected_depositing_of_dredged_material/depositing_lines_DE.shp")
...
dredge_a_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-01/dredging/dredging_mainteinance/dredgingmantainance_poly.shp")
...
dredge_1_se_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-05/Dredging/polygonCopy.shp")
...
# and both are kept):
dredge_1_de_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-05/HOLAS3_correction_DE/Corrected_dredging_36_2/dredging_areas_DE.shp")
...
dredge_p_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-01/dredging/dredging_mainteinance/dredgingmantainance_point.shp")
dredge_3 <- st_read(dredge_p_file) %>% st_zm() %>% select(geometry)

# SE data:
dredge_p_se_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-05/Dredging/point.shp")
dredge_p_se <- st_read(dredge_p_se_file) %>% select(geometry)

# DE data:
dredge_p_de_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-05/HOLAS3_correction_DE/Corrected_dredging_36_2/dredging_points_DE.shp")
...
```{r}
dredge_l_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-05/HOLAS3_correction_DE/Corrected_dredging_36_2/dredging_lines_DE.shp")
...
pipeline_file1 <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-01/pipelines/PIPELINE/Pipelines_polygons.shp")
...
pipeline_file1 <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-01/pipelines/PIPELINE/PIPELINE_append.shp")
...
pipeline_o <- rbind(pipline_o1,pipeline_o2)
...
cable_o_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-01/cables/CABLES/CABLES_append.shp")
...
cable_o2_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-05/HOLAS3_DE_HA/CABLES.shp")
...
wind_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-01/wind farms/Wind farms_operational/WINDTURBINES_append.shp")
...
wind_de_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-05/HOLAS3_DE_HA/WIND TURBINES.shp")
...
def_1_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-01/coastal defence and flood protection/CoastalDefence_lines/CoastalDefense_polygons.shp")
def_1 <- st_read(def_1_file) %>% st_zm() %>% st_make_valid() %>% select(geometry)

# SE polygon data, treated as operational:
def_2_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-05/Coastal defence/coastal_defence_3035.shp")
def_2 <- st_read(def_2_file) %>% st_zm() %>% select(geometry)

# main point data, all treated as operational:
def_3_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-01/coastal defence and flood protection/CoastalDefence_lines/CoastalDefense_points.shp")
def_3 <- st_read(def_3_file) %>% select(geometry)

# SE point data, no information on status, treated as operational:
def_4_file <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-05/Coastal defence/coastal_defence_point_3035.shp")
def_4 <- st_read(def_4_file) %>% st_transform(coordSystem) %>% select(geometry)

# line data:
def_5_file <- file.path(myDir, "../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-01/coastal defence and flood protection/CoastalDefence_lines/CoastalDefence_lines_APPEND.shp")
...
ship_folder <- file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-01/shipping/All ship types")
...
depths <- rast(file.path(myDir,"../../Daten/HELCOM-Daten/HOLAS III/Data from 2022-07-01/shipping/depth rasters/depth_1x1km.tif"))
tmp <- terra::extract(depths,ship_vect, 'mean')
...
#
# doesn't work, where's the error? (done in QGIS instead)
#
ship_vect <- mutate(ship_vect, intensity = case_when(
  depthzone == 1 ~ paste0(density),
  depthzone == 2 ~ paste0(density/2.0),
  depthzone == 3 ~ paste0(density/4.0),
  depthzone == 4 ~ paste0(density/10.0),
  TRUE ~ 0 
))
...
# the union in the following statement took roughly 20 hours on my machine using the QGIS function, on ArGIS the union fails with an unspecific error:
