...
After an initial and not comprehensive test, it seems that the union function in the new terr package is even faster than using a QGIS process for smaller files:
...
if (! use_pre_calculated_data) {
	...
	cumi_Sensitivities <- tribble(
		...
		"Latvia", "infra mud", "5-7.5",  "moderate",      "mmoderate",
		...
		"Lithuania", "infra mud", "5-7.5", "mmoderate",   "moderate",
...
if (use_pre_calculated_data) {
	...
	fisheryQuarters <- c("1","2","3","4")
	fisheryYears <- c("2016","2017","2018","2019","2020","2021")
...
- no differentiation of fishing pressure accoring to geat type
