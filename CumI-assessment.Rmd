...
Then, a variable is set which determined whether this script uses some pre-calculated files which otherwise would need a huge amuont of comupting time to assemble.
...
dredge_1_se_file <- file.path(myDir,"2/Dredging/polygonCopy_SE.shp")
...
depths <- rast(file.path(myDir,"Base/detph rasters/depth_1x1km.tif"))
