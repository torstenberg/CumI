...
cumi_generalSensitivities <- tribble(
...
for (myC in c('a','b','c')) {# loop code here}

tmp <- areaCountryBiotopeLayer

for(i in 1:nrow(cumi_generalSensitivities)) {
	terr  <- cumi_generalSensitivities[[i, 1]]
	bio   <- cumi_generalSensitivities[[i, 2]]
	sal   <- cumi_generalSensitivities[[i, 3]]
	sensi <- cumi_generalSensitivities[[i, 4]]
	tmp$sens[tmp$Territory == terr & tmp$Biotope == bio & tmp$Sal2 == sal] <- sensi
}


cumi_fishingSensitivities <- tribble (
	~Territory, ~Biotope, ~Sal2, ~s_surf,
	"Denmark", "circa hard", "7.5-11", "high",
	"Denmark", "circa hard", "11-18", "high",
	"Denmark", "circa hard", "18-30", "high",
	"Denmark", "circa mix", "7.5-11", "low",
	"Denmark", "circa mix", "11-18", "low",
	"Denmark", "circa mix", "18-30", "low",
	"Denmark", "circa mix", ">30", "low",
	"Denmark", "circa mud", "7.5-11", "moderate",
	"Denmark", "circa mud", "11-18", "moderate",
	"Denmark", "circa mud", "18-30", "high",
	"Denmark", "circa mud", ">30", "high",
	"Denmark", "circa sand", "7.5-11", "moderate",
	"Denmark", "circa sand", "11-18", "moderate",
	"Denmark", "circa sand", "18-30", "high",
	"Denmark", "circa sand", ">30", "high",
	"Denmark", "infra hard", "7.5-11", "high",
	"Denmark", "infra hard", "11-18", "high",
	"Denmark", "infra hard", "18-30", "high",
	"Denmark", "infra hard", ">30", "high",
	"Denmark", "infra mix", "7.5-11", "low",
	"Denmark", "infra mix", "11-18", "low",
	"Denmark", "infra mix", "18-30", "high",
	"Denmark", "infra mix", ">30", "high",
	"Denmark", "infra mud", "7.5-11", "moderate",
	"Denmark", "infra mud", "11-18", "moderate",
	"Denmark", "infra mud", "18-30", "high",
	"Denmark", "infra mud", ">30", "high",
	"Denmark", "infra sand", "7.5-11", "moderate",
	"Denmark", "infra sand", "11-18", "moderate", # assumed
	"Denmark", "infra sand", "18-30", "high",
	"Denmark", "infra sand", ">30", "high",
		
	"Estonia", "circa hard", "5-7", "high",
	"Estonia", "circa hard", "7.5-11", "high",
	"Estonia", "circa mix", "5-7", "high",
	"Estonia", "circa mix", "7.5-11", "low",
	"Estonia", "circa mud", "5-7", "moderate",
	"Estonia", "circa mud", "7.5-11", "moderate",
	"Estonia", "circa sand", "5-7", "moderate",
	"Estonia", "circa sand", "7.5-11", "moderate",
	"Estonia", "infra hard", "5-7", "high",
	"Estonia", "infra hard", "7.5-11", "high",
	"Estonia", "infra mix", "5-7", "moderate", # assumed
	"Estonia", "infra mix", "7.5-11", "moderate", # assumed
	"Estonia", "infra mud", "5-7", "moderate",
	"Estonia", "infra mud", "7.5-11", "moderate",
	"Estonia", "infra sand", "5-7", "moderate",
	"Estonia", "infra sand", "7.5-11", "moderate",
		
	"Finland", "circa hard", "<5", "high",
	"Finland", "circa hard", "5-7", "high",
	"Finland", "circa hard", "7.5-11", "high", # assumed
	"Finland", "circa mix", "<5", "moderate",
	"Finland", "circa mix", "5-7", "moderate",
	"Finland", "circa mix", "7.5-11", "moderate",
	"Finland", "circa mud", "<5", "moderate",
	"Finland", "circa mud", "5-7", "moderate",
	"Finland", "circa mud", "7.5-11", "moderate",
	"Finland", "circa sand", "<5", "moderate",
	"Finland", "circa sand", "5-7", "moderate",
	"Finland", "circa sand", "7.5-11", "moderate", # assumed
	"Finland", "infra hard", "<5", "high",
	"Finland", "infra hard", "5-7", "high",
	"Finland", "infra hard", "7.5-11", "high", #assumed
	"Finland", "infra mix", "<5", "moderate",
	"Finland", "infra mix", "5-7", "moderate",
	"Finland", "infra mix", "7.5-11", "moderate", # assumed
	"Finland", "infra mud", "<5", "moderate",
	"Finland", "infra mud", "5-7", "moderate",
	"Finland", "infra mud", "7.5-11", "moderate",
	"Finland", "infra sand", "<5", "moderate",
	"Finland", "infra sand", "5-7", "moderate",
	"Finland", "infra sand", "7.5-11", "moderate", # assumed
		
	"Germany", "circa hard", "5-7", "high",
	"Germany", "circa hard", "7.5-11", "high",
	"Germany", "circa hard", "11-18", "high",
	"Germany", "circa hard", "18-30", "high",
	"Germany", "circa mix", "5-7", "low", # assumed
	"Germany", "circa mix", "7.5-11", "low",
	"Germany", "circa mix", "11-18", "high",
	"Germany", "circa mix", "18-30", "high",
	"Germany", "circa mud", "5-7", "moderate", # assumed
	"Germany", "circa mud", "7.5-11", "moderate",
	"Germany", "circa mud", "11-18", "high",
	"Germany", "circa mud", "18-30", "high",
	"Germany", "circa sand", "5-7", "moderate",
	"Germany", "circa sand", "7.5-11", "moderate",
	"Germany", "circa sand", "11-18", "moderate",
	"Germany", "circa sand", "18-30", "moderate",
	"Germany", "infra hard", "5-7", "high",
	"Germany", "infra hard", "7.5-11", "high",
	"Germany", "infra hard", "11-18", "high",
	"Germany", "infra hard", "18-30", "high",
	"Germany", "infra mix", "5-7", "moderate",
	"Germany", "infra mix", "7.5-11", "low",
	"Germany", "infra mix", "11-18", "low",
	"Germany", "infra mix", "18-30", "high",
	"Germany", "infra mud", "5-7", "moderate",
	"Germany", "infra mud", "7.5-11", "moderate",
	"Germany", "infra mud", "11-18", "moderate",
	"Germany", "infra mud", "18-30", "high",
	"Germany", "infra sand", "5-7", "moderate",
	"Germany", "infra sand", "7.5-11", "moderate",
	"Germany", "infra sand", "11-18", "high",
	"Germany", "infra sand", "18-30", "high",
		
	"Latvia", "circa hard", "5-7", "high",
	"Latvia", "circa hard", "7.5-11", "high",
	"Latvia", "circa hard", "11-18", "high", # assumed
	"Latvia", "circa mix", "5-7", "low",
	"Latvia", "circa mix", "7.5-11", "low",
	"Latvia", "circa mix", "11-18", "low",
	"Latvia", "circa mud", "<5", "moderate",
	"Latvia", "circa mud", "5-7", "moderate",
	"Latvia", "circa mud", "7.5-11", "moderate",
	"Latvia", "circa mud", "11-18", "moderate",
	"Latvia", "circa sand", "<5", "moderate",
	"Latvia", "circa sand", "5-7", "moderate",
	"Latvia", "circa sand", "7.5-11", "moderate",
	"Latvia", "circa sand", "11-18", "moderate", # assumed
	"Latvia", "infra hard", "<5", "high",
	"Latvia", "infra hard", "5-7", "high",
	"Latvia", "infra hard", "7.5-11", "high", # assumed
	"Latvia", "infra hard", "11-18", "high", # assumed
	"Latvia", "infra mix", "<5", "moderate", # assumed
	"Latvia", "infra mix", "5-7", "moderate",
	"Latvia", "infra mix", "7.5-11", "moderate", # assumed
	"Latvia", "infra mix", "11-18", "moderate", # assumed
	"Latvia", "infra mud", "<5", "moderate",
	"Latvia", "infra mud", "5-7", "moderate",
	"Latvia", "infra mud", "7.5-11", "moderate",
	"Latvia", "infra mud", "11-18", "moderate", # assumed
	"Latvia", "infra sand", "<5", "moderate",
	"Latvia", "infra sand", "5-7", "moderate",
	"Latvia", "infra sand", "7.5-11", "moderate", # assumed
	"Latvia", "infra sand", "11-18", "moderate", # assumed
		
	"Lithuania", "circa hard", "5-7", "high",
	"Lithuania", "circa hard", "7.5-11", "high",
	"Lithuania", "circa mix", "5-7", "low",
	"Lithuania", "circa mix", "7.5-11", "low",
	"Lithuania", "circa mix", "11-18", "low", # assumed
	"Lithuania", "circa mud", "5-7", "moderate",
	"Lithuania", "circa mud", "7.5-11", "moderate",
	"Lithuania", "circa sand", "<5", "moderate", # assumed
	"Lithuania", "circa sand", "5-7", "moderate",
	"Lithuania", "circa sand", "7.5-11", "moderate",
	"Lithuania", "infra hard", "<5", "high", # assumed
	"Lithuania", "infra hard", "5-7", "high", # assumed
	"Lithuania", "infra hard", "7.5-11", "high", # assumed
	"Lithuania", "infra mix", "5-7", "moderate",
	"Lithuania", "infra mix", "7.5-11", "moderate", # assumed
	"Lithuania", "infra mud", "5-7", "moderate",
	"Lithuania", "infra mud", "7.5-11", "moderate", # assumed
	"Lithuania", "infra sand", "5-7", "moderate",
	"Lithuania", "infra sand", "7.5-11", "moderate", # assumed
			
	"Poland", "circa hard", "5-7", "high",
	"Poland", "circa hard", "7.5-11", "high",
	"Poland", "circa hard", "11-18", "high", # assumed
	"Poland", "circa mix", "5-7", "moderate", # assumed
	"Poland", "circa mix", "7.5-11", "moderate",
	"Poland", "circa mix", "11-18", "moderate", # assumed
	"Poland", "circa mud", "5-7", "moderate",
	"Poland", "circa mud", "7.5-11", "moderate",
	"Poland", "circa mud", "11-18", "moderate",
	"Poland", "circa sand", "5-7", "moderate",
	"Poland", "circa sand", "7.5-11", "moderate",
	"Poland", "circa sand", "11-18", "moderate",
	"Poland", "infra hard", "5-7", "high",
	"Poland", "infra hard", "7.5-11", "high",
	"Poland", "infra hard", "11-18", "high",
	"Poland", "infra mix", "<5", "moderate",
	"Poland", "infra mix", "5-7", "moderate",
	"Poland", "infra mix", "7.5-11", "moderate",
	
	"Poland", "infra mud", "<5", "moderate",
	"Poland", "infra mud", "5-7", "moderate",
	"Poland", "infra mud", "7.5-11", "moderate",
	"Poland", "infra mud", "11-18", "moderate",
	"Poland", "infra sand", "<5", "moderate",
	"Poland", "infra sand", "5-7", "moderate",
	"Poland", "infra sand", "7.5-11", "moderate",
	"Poland", "infra sand", "11-18", "moderate", # assumed
		
	"Russia", "circa mix", "5-7", "moderate",
		
	"Sweden", "circa hard", "<5", "low",
	"Sweden", "circa hard", "5-7", "high",
	"Sweden", "circa hard", "7.5-11", "high",
	"Sweden", "circa hard", "11-18", "high",
	"Sweden", "circa hard", "18-30", "high",
	"Sweden", "circa hard", ">30", "high",
	"Sweden", "circa mix", "<5", "low",
	"Sweden", "circa mix", "5-7", "low",
	"Sweden", "circa mix", "7.5-11", "moderate",
	"Sweden", "circa mix", "11-18", "moderate",
	"Sweden", "circa mix", "18-30", "high",
	"Sweden", "circa mix", ">30", "moderate",
	"Sweden", "circa mud", "<5", "low",
	"Sweden", "circa mud", "5-7", "moderate",
	"Sweden", "circa mud", "7.5-11", "moderate",
	"Sweden", "circa mud", "11-18", "moderate",
	"Sweden", "circa mud", "18-30", "high",
	"Sweden", "circa mud", ">30", "high",
	"Sweden", "circa sand", "<5", "low",
	"Sweden", "circa sand", "5-7", "moderate",
	"Sweden", "circa sand", "7.5-11", "moderate",
	"Sweden", "circa sand", "11-18", "moderate",
	"Sweden", "circa sand", "18-30", "high",
	"Sweden", "circa sand", ">30", "high",
	"Sweden", "infra hard", "<5", "low",
	"Sweden", "infra hard", "5-7", "moderate",
	"Sweden", "infra hard", "7.5-11", "high",
	"Sweden", "infra hard", "11-18", "high",
	"Sweden", "infra hard", "18-30", "high",
	"Sweden", "infra hard", ">30", "high",
	"Sweden", "infra mix", "<5", "low",
	"Sweden", "infra mix", "5-7", "moderate",
	"Sweden", "infra mix", "7.5-11", "moderate",
	"Sweden", "infra mix", "11-18", "high",
	"Sweden", "infra mix", "18-30", "high",
	"Sweden", "infra mix", ">30", "high",
	"Sweden", "infra mud", "<5", "low",
	"Sweden", "infra mud", "5-7", "moderate",
	"Sweden", "infra mud", "7.5-11", "moderate",
	"Sweden", "infra mud", "11-18", "high",
	"Sweden", "infra mud", "18-30", "high",
	"Sweden", "infra mud", ">30", "high",
	"Sweden", "infra sand", "<5", "low",
	"Sweden", "infra sand", "5-7", "moderate",
	"Sweden", "infra sand", "7.5-11", "moderate",
	"Sweden", "infra sand", "11-18", "moderate",
	"Sweden", "infra sand", "18-30", "moderate", # assumed
	"Sweden", "infra sand", ">30", "high"
)


areaCountryBiotopeLayer <- tmp
```
...
```{r}
species_folder <- "/Users/Torsten/Marilim/OneDrive/OneDrive - MariLim Gesellschaft für Gewässeruntersuchung mbH/MSRL/Daten/HELCOM-Daten/HOLAS II/Benthic species"
...
Starting from the pre-defined sensitivities, two countries have requested changes to these during the sensitivity survey which was done in June 2021 within the EN BENTHIC group. Those changes are implemented in the following step (only for those polygons where the sensitivity not was raised to 'high' due to presence of sensitive species):
...
if (! use_pre_calculated_data) {
	...
	# additional fix for DK:
	biotopeLayer$s_surf[biotopeLayer$sens_spec == 0 & biotopeLayer$Territory == "Denmark" & biotopeLayer$Biotope == "circa mix"] <- "low"
	# changes for Sweden:
