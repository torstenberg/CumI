...
myDir <- "/Users/Torsten/Library/CloudStorage/OneDrive-MariLimGesellschaftfürGewässeruntersuchungmbH/MSRL/CumI-R/Data-2023-01-20"
```
...
if (! use_pre_calculated_data && do_cumi) {
  ...
  species_folder <- file.path(myDir,"Biotopes/Benthic species HOLAS 3")
...
st_write(areaCountryBiotopeLayer,paste("/Users/Torsten/species_",myShort,".gpkg"))
...
if (! use_pre_calculated_data && do_cumi) {
	...
	salinity_file <- file.path(myDir,"../Data-2022/Salinity/BALANCE_BOTTOM_SALINITY.tif")
...
if (! use_pre_calculated_data && do_cumi) {
	...
	for(i in 1:nrow(tmp)) {
		...
		shortName <- case_when(
			...
			bio == "Grobesedimente des Circalitorals" ~ "circa hard", # miss-spelling
